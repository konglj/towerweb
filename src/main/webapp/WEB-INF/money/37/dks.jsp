					...
					<div class="form-group">
						...
						<div class="col-md-9">
							...
							<select name="parameter.usercity" id="usercity" class="form-control" ref="userdistrict">
										 <c:forEach items="${txPage.userParamerCitys }" var="city">
      							  		 <option value="${city.cityid}" <c:if test='${city.cityid==txPage.parameter.usercity }'>selected="selected"</c:if>  >${city.cityname }</option>
      								    </c:forEach>
      								</select>
      						</div>		
      					<div class="col-md-6" style="padding-right:0px;">
			...
			<div class="row" style="margin-top: 5px">
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<div class="col-md-8">
							<select name="parameter.state" id="state" class="form-control combox" >
...
<script src="<%=basePath%>assets/js/page/money/37/dk.js"></script>
