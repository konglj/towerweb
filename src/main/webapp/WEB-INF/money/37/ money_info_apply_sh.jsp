	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group">
				<label class="control-label col-md-4">打款信息：</label>
				<div class="col-md-8">
					<textarea id="dkinfo" rows="3" name="dkinfo" style="width: 100%;"></textarea>
				</div>
			</div>
		</div>
		...
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-4">
					<div class="row">
						<div class="col-md-offset-3 col-md-4">
							<button type="button" class="btn green" onclick="sh_money_dk(0,'审核拒绝')">
