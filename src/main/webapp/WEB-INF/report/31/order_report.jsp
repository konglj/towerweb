				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="row">
								<div class="col-md-6" >
									<select name="parameter.towerdistrict" id="towerdistrict" class="form-control combox" ref="area" refUrl="${ctx}/procity?pro_code={value}&city_code=HSLY">
								...
								<div class="col-md-6" >
									<select name="parameter.towerarea" id="towerarea" class="form-control">
										 <c:forEach items="${reportOrderPage.paramerAreas }" var="area">
      							  		 <option value="${area.id}" <c:if test='${area.id==reportOrderPage.parameter.towerarea }'>selected="selected"</c:if>  >${area.areaname }</option>
      								    </c:forEach>
      								</select>
								</div>
							</div>
...
<script src="<%=basePath%>assets/js/page/report/31/orders.js"></script>
