	...
	<div class="row" >
		<div class="col-md-12">
			<div class="form-group">
				<label class="control-label col-md-2">   单项服务协议：</label>
				<div class="col-md-10">
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<input type="text" class="form-control" placeholder=""
						id="towerprojectno" name="towerprojectno">
				</div>
			</div>
		</div>
		<div class="col-md-6">
			<div class="form-group">
				...
				<div class="col-md-8">
					<input type="text" class="form-control" placeholder=""
						id="towerprojectname" name="towerprojectname">
				</div>
			</div>
		</div>
					...
					<div class="row">
						<div class="col-md-offset-3 col-md-4">
							<button type="button" class="btn green"
								onclick="order_fee_apply()">
								<i class="glyphicon glyphicon-ok"></i>提交单项服务协议
							</button>
						</div>
					</div>
				</div>
