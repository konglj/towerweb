			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-md-8">
							<p class="form-control-static">
								${order.towerdistrictname}-${order.towerareaname}
							</p>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-md-8">
							<p class="form-control-static">
								<c:if test="${not empty orderPage.ordertower.towerfile}">
									<a href="../../${orderPage.ordertower.towerfile}" name="a_ht_img" download="单项服务协议文件">点击下载单项服务协议文件</a>
								</c:if>
							</p>
						</div>
					</div>
...
<script src="<%=basePath%>assets/js/page/order/31/orderinfo.js"></script>