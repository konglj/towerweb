				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="row">
								<div class="col-md-6" >
									<select name="towercity" id="towercity" class="form-control"  ref="towerdistrict">
										 <c:forEach items="${towerAnalysisPage.paramerCitys }" var="city">
      							  		 <option value="${city.cityid}" <c:if test='${city.cityid==towerAnalysisPage.city }'>selected="selected"</c:if>  >${city.cityname }</option>
      								    </c:forEach>
      								</select>
								</div>
								<div class="col-md-6"   >
									<select id="towerdistrict" name="towerdistrict" class="form-control combox"  >
...
<script src="<%=basePath%>assets/js/page/analysis/37/tower_analysis.js"></script>
