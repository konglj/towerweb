...
<div class="portlet box blue">
	...
	<!-- BEGIN EXAMPLE TABLE PORTLET-->
		...
		<div class="portlet-body table-responsive2 " >
			...
			<div class="clearfix">
			<div class="btn-group">
				<a href="javascript:;" onclick="check_auth(1,'A2',updateTowerVisible);">
					<button type="button" class="btn green" style="margin-right: 20px;">
					上架选中站址<i class="icon-arrow-down"></i>
				</button>
				</a>
				
				<a href="javascript:;" onclick="check_auth(2,'A2',updateTowerVisible);">
					<button type="button" class="btn green" style="margin-right: 20px;">
					选中站址移至站址池<i class="icon-arrow-down"></i>
				</button>
				</a>
...
<script src="<%=basePath%>assets/js/page/tower/37/tower_no.js"></script>
