									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-md-8">
													<select class="form-control input-small col-md-6" id="towercity" name="towercity" ref="towerdistrict">
									 					<c:forEach items="${towersPage.paramerCitys }" var="city">
      							  							<option value="${city.cityid}" <c:if test='${city.cityid==towersPage.tower.towercity }'>selected="selected"</c:if>  >${city.cityname }</option>
      												 	</c:forEach>
      												</select>
...
<script src="<%=basePath%>assets/js/page/tower/37/tower_edit.js"></script>