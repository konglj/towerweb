		...
		init: function() {
			...
			$('#sample_1')
				.dataTable({
					...
					"sAjaxSource": "./tower/get_towers.html?towervisible=1", // 方法名 selectAll
					"columns": [{
					...
					columnDefs: [{
						...
						},
						{
							...
							render: function(a, b, c, d) {
								...
								+ '&nbsp;&nbsp;' + 
								'<a   onclick=check_auth('+id+',"A2",updateTowerToNo)><span class="glyphicon glyphicon-list"  title="抢单历史" ></span>  </a> ';
