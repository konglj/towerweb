					...
					columnDefs: [
						
						{
							...
							render: function(a, b, c, d) {
								...
								if(towerstate==4||towerstate==7){
										res=res+ '&nbsp;&nbsp;' + 
								      '<a   onclick=check_auth_ordersh('+id+','+towerstate+',"A2",UpdateOrderShjj)><span class="glyphicon glyphicon-cog"  title="审核拒绝" ></span>  </a> ';
								}
...
function UpdateOrderShjj(id,towerstate){
